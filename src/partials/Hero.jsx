  ...
  return (
    <section id="hero-section">
      <div className="max-w-6xl mx-auto px-8 md:px-4 h-full">
        <div
          id="hero-container"
          className="pt-32 md:pt-40 md:pb-20 flex flex-col justify-center m-auto h-full"
        >
          {/* Section header */}
          <div className="max-w-3xl h-full mx-auto text-center pb-12 h-max">
            ...
            <h1 className="text-white h1 mb-4">
              ...
              {/* <br></br>Digital Transformation and  */}
              <br></br> Enterprise AI
            </h1>
            <p className="md:text-xl text-md text-white">
              ...
              At C3 AI, Product Designers drive innovation at the frontier of
              Enterprise AI. Working closely with our customers, we develop
              powerful AI-based tools and applications that have the potential
              to change the world.
            </p>
          </div>
            ...
            <div className="max-w-3xl mx-auto">
              ...
              >
                <div>
                  ...
                  <a
                    className="main-cta btn text-black font-bold bg-white w-full"
                    href="#career"
                  >
                    Join Our Team
                  </a>
